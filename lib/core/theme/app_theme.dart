...
/// PantryPal Theme - Cute, Friendly Aesthetic
class AppTheme {
  AppTheme._();
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(borderRadius: borderRadiusLarge, borderSide: BorderSide.none),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: GoogleFonts.nunito(color: textPrimary, fontSize: 13, fontWeight: FontWeight.w500),
        shape: RoundedRectangleBorder(borderRadius: borderRadiusMedium),
      ...
      dialogTheme: DialogThemeData(
        ...
        contentTextStyle: GoogleFonts.nunito(fontSize: 14, color: textSecondary),
      ),
  ...
  static TextTheme _buildTextTheme() {
    return TextTheme(
      displayLarge: GoogleFonts.nunito(fontSize: 57, fontWeight: FontWeight.w400, color: textPrimary),
      displayMedium: GoogleFonts.nunito(fontSize: 45, fontWeight: FontWeight.w400, color: textPrimary),
      displaySmall: GoogleFonts.nunito(fontSize: 36, fontWeight: FontWeight.w400, color: textPrimary),
      headlineLarge: GoogleFonts.nunito(fontSize: 32, fontWeight: FontWeight.w700, color: textPrimary),
      headlineMedium: GoogleFonts.nunito(fontSize: 28, fontWeight: FontWeight.w700, color: textPrimary),
      headlineSmall: GoogleFonts.nunito(fontSize: 24, fontWeight: FontWeight.w700, color: textPrimary),
      titleLarge: GoogleFonts.nunito(fontSize: 22, fontWeight: FontWeight.w600, color: textPrimary),
      titleMedium: GoogleFonts.nunito(fontSize: 16, fontWeight: FontWeight.w600, color: textPrimary),
      titleSmall: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w600, color: textPrimary),
      bodyLarge: GoogleFonts.nunito(fontSize: 16, fontWeight: FontWeight.w400, color: textPrimary),
      bodyMedium: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w400, color: textPrimary),
      bodySmall: GoogleFonts.nunito(fontSize: 12, fontWeight: FontWeight.w400, color: textSecondary),
      labelLarge: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w600, color: textPrimary),
      labelMedium: GoogleFonts.nunito(fontSize: 12, fontWeight: FontWeight.w600, color: textPrimary),
      labelSmall: GoogleFonts.nunito(fontSize: 11, fontWeight: FontWeight.w600, color: textSecondary),
    );
  }
}
