    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
            borderRadius: borderRadiusLarge, borderSide: BorderSide.none),
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        unselectedLabelStyle:
            GoogleFonts.nunito(fontSize: 12, fontWeight: FontWeight.w500),
      ),
      ...
      chipTheme: ChipThemeData(
        ...
        padding: const EdgeInsets.symmetric(
            horizontal: spacingS, vertical: spacingXS),
      ),
      dialogTheme: DialogThemeData(
        ...
        contentTextStyle:
            GoogleFonts.nunito(fontSize: 14, color: textSecondary),
      ),
